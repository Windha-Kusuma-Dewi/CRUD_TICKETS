                        ...
                        <form action="{{ route('xss-lab.stored.secure.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="author_name" id="author_name"
                                    class="form-control @error('author_name') is-invalid @enderror" required maxlength="100"
                                    value="{{ old('author_name') }}" placeholder="Masukkan nama Anda">
                                @error('author_name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="content" id="content" rows="3" class="form-control @error('content') is-invalid @enderror"
                                    required maxlength="1000" placeholder="Tulis komentar Anda...">{{ old('content') }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
{{-- Kombinasi keduanya: line breaks tetap ada, tapi aman dari XSS --}}
</code></pre>
                    </div>
                </div>
